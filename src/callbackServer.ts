 ...
 */
export function registerTask(taskId: string): Promise<any> {
...
app.post(
  "/api/callback",
  (req: Request<{}, {}, CallbackBody>, res: Response) => {
...
app.post(
  "/api/content-plan",
  async (req: Request<{}, {}, ContentPlanBody>, res: Response) => {
    try {
      const {
        title,
        description,
 ...
 */
export function startCallbackServer(port: number = 3000): Promise<any> {
  return new Promise((resolve, reject) => {
    try {
